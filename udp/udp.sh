...
wget "raw.githubusercontent.com/Hyung098/x/main/udp/udp" -O /root/udp/udp &>/dev/null
chmod +x /root/udp/udp


echo -e "${Green}Downloading File ....${NC}"
wget "raw.githubusercontent.com/Hyung098/x/main/udp/config.json" -O /root/udp/config.json &>/dev/null
